...
const greeting = {
  ...
  intro: "Hello, I am a software engineer based in California. I am a senior pursuing my bachelor's in Computer Science at San Jose State University. I love to design software that adds value to people's lives. Throughout my undergrad, I have been focused on learning new technologies and quality development practices to build reliable, scalable, and secure backend services surrounding full stack development. My education has provided me with the opportunity to work alongside very creative and passionate people who love to solve problems with code as well.",
